    ...
    if not message.media:
        ...
        if "facebook" in link or "fb" in link:
            ...
            try:
                ...
                js = (
                    str(bs)
                    .replace(
                        '<html><head></head><body>{"status":"ok","p":"facebook","links":',
                        "",
                    )
                    .replace("</body></html>", "")
                    .replace("},", ",")
                ...
                sent_message = message.reply_text(
                    "🕵️**Your Facebook Link is Private & SO I Cannot Download**",
                    quote=True,
                )
        ...
        if "solidfiles" in link:
            ...
            try:
                ...
                sent_message = message.reply_text(
                    "🕵️**Solidfiles link error...**", quote=True
                )
        ...
        if "anonfiles" in link:
            ...
            try:
                ...
                sent_message = message.reply_text(
                    "🕵️**Anonfiles link error...**", quote=True
                )
        ...
        if "mediafire.com" in link:
            ...
            try:
                ...
                sent_message = message.reply_text(
                    "🕵️**mediafire link error...**", quote=True
                )
...
def _telegram_file(client, message):
    ...
    sent_message.edit(
        Messages.DOWNLOAD_TG_FILE.format(
            final_name, humanbytes(file.file_size), file.mime_type
        )
    )
